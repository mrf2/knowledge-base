...
|---|---|---|---|
|P3.0|RXD|0xB0|Receive data for serial port|
|P3.1|TXD|0xB1|Transmit data for serial port|
|P3.2|$\overline{INT0}$|0xB2|External interrupt 0|
|P3.3|$\overline{INT1}$|0xB3|External interrupt 1|
|P3.4|T0|0xB4|Timer/Counter 0 external input|
|P3.5|T1|0xB5|Timer/Counter 1 external input|
|P3.6|$\overline{WR}$|0xB6|External data memory write strobe|
|P3.7|$\overline{RD}$|0xB7|External data memory read strobe|
|P1.0|T2|0x90|Timer/Counter 2 external input|
|P1.1|T2EX|0x91|Timer/Counter 2 capture/reload|


## PSW (Program Status Word) Register Summary
|Bit|Symbol|Address|Bit Description|
|---|---|---|---|
|PSW.0|P|0xD0|Even Parity Flag|
|PSW.1|--|0xD1|Reserved|
|PSW.2|OV|0xD2|Overflow Flag|
|PSW.3|RS0|0xD3|Register Bank Select 0|
|PSW.4|RS1|0xD4|Register Bank Select 1|
|PSW.5|F0|0xD5|Flag 0|
|PSW.6|AC|0xD6|Auxilllary Carry Flag|
|PSW.7|CY|0xD7|Carry Flag|

### Register Bank Select
|PSW.4|PSW.3|Bank|Address Range|
|---|---|---|---|
